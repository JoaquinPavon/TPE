...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2022 a las 20:29:15
...
(17, 16, 'Simulaciónes', 'Aviones, simuladores de una situación o instrumentales. Permiten experimentar e investigar el funcionamiento de máquinas, fenómenos, situaciones y asumir el mando.\r\n'),
...
INSERT INTO `juegos` (`ID_Juego`, `Nombre`, `Fecha`, `Precio`, `Descripcion`, `imagen`, `Genero_ID`) VALUES
(25, 'Counter-Strike: Global Offensive', 'Aug 21, 2012', 1600, 'Es un videojuego de disparos en primera persona desarrollado por Valve Corporation y Hidden Path Entertainment. Es el cuarto juego de la saga Counter-Strike. Juego Shooter actualmente mas jugado y visto en la actualidad, nuevas granadas/mapas/estrategias se van actualizando con el tiempo.', '', 18),
...
(27, 'Civilization IV', 'Nov 16, 2009', 750, 'La entrega numero cuatro de esta legendaria saga, creada por Sid Meier. La cual hará un recorrido por la historia de la humanidad desde la era de piedra hasta la era espacial. Civilization IV incluye impotentes novedades como las religiones o los lideres, y varios y novedosos modo multijugador.', '', 15),
...
(1, 'joacopavon@hotmail.com', '$2a$12$PvwHHXVRkDviHGI/NDLANuMtNXwb4x6hD0C1BmlbcM2PnD8INBuTS');
...
--
ALTER TABLE `generos`
  MODIFY `Genero_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
